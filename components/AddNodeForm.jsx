...
export default function AddNodeForm({ onSuccess, onCancel }) {
  ...
  return (
    <div className="bg-card border border-border rounded-xl p-8">
      <h2 className="text-2xl font-bold text-foreground mb-6">Add New Node</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              value={formData.host}
              onChange={handleChange}
              placeholder="e.g., 188.245.207.225"
              required
              className="w-full px-4 py-2 bg-background border border-border rounded-lg text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary"
            />
          </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            placeholder="https://stackryze.com"
            className="w-full px-4 py-2 bg-background border border-border rounded-lg text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            placeholder="https://discord.gg/stackryze"
            className="w-full px-4 py-2 bg-background border border-border rounded-lg text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary"
          />
        </div>
